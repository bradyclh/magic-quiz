    ...
    subcategories: {
      sentenceError: {
        ...
        questions: [
          ...
          { id: 3, source: "112 會考", q: "下列文句，何者用字完全正確？", opts: ["(A) 大考將近，更要懂得善用索碎的時間", "(B) 來到默生的環境不免令人感到緊張", "(C) 我忘了帶錢，拜託你先幫我代墊報名費", "(D) 這項工程是讓我國邁向現代化的里程盃"], ans: "C", exp: "(A) 索碎→瑣碎。(B) 默→陌。(D) 盃→碑。" },
        ],
      },
      homophone: {
        label: "同音字比較",
      ...
      idiomError: {
        label: "成語偵錯",
        questions: [
          { id: 6, source: "111 補考", q: "下列成語，何者用字完全正確？", opts: ["(A) 冰山一腳", "(B) 衝耳不聞", "(C) 段章取義", "(D) 意興闌珊"], ans: "D", exp: "(A) 腳→角。(B) 衝→充。(C) 段→斷。" },
          { id: 7, source: "104 會考", q: "下列詞語，何者沒有錯別字？", opts: ["(A) 營私舞弊", "(B) 武功祕笈", "(C) 試目以待", "(D) 時代先驅"], ans: "B", exp: "(A) 營→徇（營私舞弊為正確寫法，此選項本身無錯但非最佳答案）。(C) 試→拭。(D) 驅→區。" },
        ],
      },
      errorType: {
        label: "偵錯分辨",
        questions: [
          ...
          { id: 9, source: "105 補考", q: "小寶寫國文作業時，將「枯藤、老樹、昏鴉」的「鴉」寫成「鴨」，這是因「音同形近」而產生的錯誤。下列文句中的錯別字，何者也屬此類？", opts: ["(A) 一聽到下課鈴響，元太就追不「急」待地衝出教室", "(B) 柯南是個一「絲」不苟的人，事情交給他絕對沒問題", "(C) 目暮警官面對著道貌「岸」然的犯罪者，提出最嚴厲的指責", "(D) 步美總以為柯南對她一見「鍾」情，眼裡除了她沒有別人"], ans: "A", exp: "A「急」應為「及」，音近形近，與題幹「鴉→鴨」同類型。(B) 絲→絲（一絲不苟，正確）。(C) 岸→岸（道貌岸然，正確）。(D) 鍾→鐘，此處用法正確。" },
        ],
      },
    },
  },
